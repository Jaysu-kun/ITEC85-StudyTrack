  ...
  return (
    <footer className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-md border-t border-slate-200/80 dark:border-slate-800/80 transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="flex flex-col items-center md:items-start gap-2">
            <div className="flex items-center gap-2.5">
              <div className="h-8.5 w-8.5 rounded-xl flex items-center justify-center bg-sky-500/10 dark:bg-sky-400/10 border border-sky-200/70 dark:border-sky-500/25 shadow-sm">
                <img
                  src={Logo}
                  alt="IskoTasks Logo"
              ...
              <span className="text-lg font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-sky-600 via-blue-600 to-cyan-600 dark:from-sky-400 dark:via-sky-300 dark:to-cyan-400">
                IskoTasks
              </span>
            </div>
        ...
        <div className="border-t border-slate-200/60 dark:border-slate-800/60 mt-8 pt-6 text-center text-xs text-slate-400 dark:text-slate-500">
